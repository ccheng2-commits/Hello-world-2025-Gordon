# DeepForst: Text Adventure with RPS Mechanics (with ASCII art at start)

import random

# ----- show ASCII art at start (no function, print directly) -----
try:
    with open("savvy_ascii.txt", "r", encoding="utf-8") as f:
        art = f.read()
        print(art)
except FileNotFoundError:
    print("[ASCII Art not found. Make sure savvy_ascii.txt is in the same folder.]")
...
def scene_madison():
    ...
    print('Mysterious Person: "Can you resist meaningless assignments?')
